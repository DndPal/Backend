export class AuthenticationDiTokens {
    public static readonly SessionRepositoryInterface: string = "SessionRepositoryInterface";
    public static readonly MySQLSessionRepositoryInterface: string = "MySQLSessionRepositoryInterface";
