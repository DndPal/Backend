...
const repositoryProviders: Array<Provider> = [
    ...
    },
    {
        ...
        useFactory: (repository: Repository<Item>) => new ItemRepository(repository),
        inject: [ItemDiTokens.MySQLItemRepositoryInterface]
    },
    {
        provide: ItemDiTokens.MySQLItemPresetRepositoryInterface,
        useFactory: (dataSource: DataSource) => dataSource.getRepository(ItemPreset),
        inject: [DatabaseDiTokens.MySQLDataSource]
    },
    {
        provide: ItemDiTokens.ItemPresetRepositoryInterface,
        useFactory: (repository: Repository<ItemPreset>) => new ItemPresetRepository(repository),
        inject: [ItemDiTokens.MySQLItemPresetRepositoryInterface]
    }
];
...
const serviceProviders: Array<Provider> = [
    {
        ...
        useFactory: (repository: ItemRepositoryInterface) => new FindItemByIdAndCharacterIdService(repository),
        inject: [ItemDiTokens.ItemRepositoryInterface]
    },
    {
        provide: ItemDiTokens.FindItemPresetByIdService,
        useFactory: (repository: ItemPresetRepositoryInterface) => new FindItemPresetByIdService(repository),
        inject: [ItemDiTokens.ItemPresetRepositoryInterface]
    },
    {
        provide: ItemDiTokens.SaveArmorPresetService,
        useFactory: (repository: ItemPresetRepositoryInterface) => new SaveArmorPresetService(repository),
        inject: [ItemDiTokens.ItemPresetRepositoryInterface]
    },
    {
        provide: ItemDiTokens.SaveWeaponPresetService,
        useFactory: (repository: ItemPresetRepositoryInterface) => new SaveWeaponPresetService(repository),
        inject: [ItemDiTokens.ItemPresetRepositoryInterface]
    },
    {
        provide: ItemDiTokens.SaveItemService,
        useFactory: (repository: ItemRepository) => new SaveItemService(repository),
        inject: [ItemDiTokens.ItemRepositoryInterface]
    }
